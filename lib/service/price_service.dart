      ...
      WeddingFormula(1, "Just Married",
          ...
          events: [
            WeddingEvent(2, "ceremony",
                ...
                pathIcon: "assets/images/diamond.svg"),
            WeddingEvent(3, "wine",
                description: "Vin d'honneur",
                pathIcon: "assets/images/cheers.svg"),
            WeddingEvent(5, "photo",
                description: "Photo de groupe/couple",
                pathIcon: "assets/images/camera.svg"),
          ]),
      WeddingFormula(
        2,
        "Emotions",
        ...
        events: [
          WeddingEvent(1, "preparation",
              ...
              pathIcon: "assets/images/high-heels.svg"),
          WeddingEvent(2, "ceremony",
              description: "Cérémonie", pathIcon: "assets/images/diamond.svg"),
          WeddingEvent(3, "wine",
              description: "Vin d'honneur",
              pathIcon: "assets/images/cheers.svg"),
          WeddingEvent(5, "photo",
      ...
      WeddingFormula(
        ...
        events: [
          ...
          WeddingEvent(4, "cake",
              ...
              pathIcon: "assets/images/wedding-cake.svg"),
          WeddingEvent(5, "photo",
              description: "Photo de groupe/couple",
              pathIcon: "assets/images/camera.svg"),
        ],
